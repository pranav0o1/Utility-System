...
//    new RotateImage45Degrees("back.png");
//  }
//
//}
//          
...
ImageIcon apple1 = new ImageIcon("Apple.gif");
ImageIcon apple2 = new ImageIcon("Apple.gif");
...
add(rotationPanel);
rotationPanel.setBounds(WIDTH/2, HEIGHT/2, rotationPanel.getPreferredSize().width, rotationPanel.getPreferredSize().height);
degrees = 0;
}
public void paintComponent (Graphics g)
{
super.paintComponent(g);
apple1.paintIcon(this, g, 100, 75);
apple2.paintIcon(this, g, WIDTH-100, HEIGHT-75);
